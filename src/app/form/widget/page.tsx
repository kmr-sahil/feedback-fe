  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <div className="w-full max-w-[70rem] mx-auto">
        <DashboardLayout>
          <WidgetComponent projectId={activeProject || ""} />
          <div className="container mx-auto py-10 max-w-[48rem]">
    ...
    <div>
      ...
      <FeedbackWidget projectId="your-project-id" />
                ...
                <p className="mt-4 text-sm text-gray-600">
                  Replace "your-project-id" with the actual project ID you want
                  to use for collecting feedback.
                </p>
              </CardContent>
            </Card>
          </div>
