    ...
    <DashboardLayout>
      <div className="relative bg-backgroundOne border-special border-backgroundTwo rounded-[12px] p-[1rem] flex flex-col items-center justify-center gap-[1rem]">
        ...
        <div className="absolute bottom-2 right-2 flex gap-2">
          <select
            ...
            className="p-2 rounded-md bg-zinc-200 border-[1px] border-zinc-300 bg-opacity-70 text-zinc-600"
          >
      ...
      <div className="w-full p-4 bg-zinc-50 border border-zinc-200 rounded-lg mt-4">
        ...
        <p className="text-sm text-gray-600 mb-1">
          Use the following API key and URL to fetch reviews for your project:
        </p>
