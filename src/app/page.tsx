...
export default function CompanySearch() {
  ...
  return (
    <div className="flex flex-col relative gap-[1rem] justify-center items-center px-[1rem] max-w-[78rem] mx-auto">
      <Navbar />
      <div className=" relative w-full flex flex-col justify-center items-center space-y-4 bg-[#379777] px-[1rem] pb-[2rem] sm:px-[4rem] lg:px-[16rem] mt-[6rem] md:pt-[4rem] md:pb-[3rem] text-white rounded-[1rem]">
