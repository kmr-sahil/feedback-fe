  ...
  return (
    <div className="w-full h-screen flex justify-center items-center bg-zinc-100 p-[1rem]">
      <motion.div
        ...
        className={`max-w-[30rem] flex-grow p-[1.5rem] bg-gradient-to-r from-zinc-50 to-zinc-100 rounded-[1rem] text-zinc-700 flex flex-col gap-6 border-[2px] border-zinc-200 ${
      ...
      >
        {/* Star Input */}
        <motion.div
          className={`h-[5rem] ${showInputs ? "scale-75" : "scale-100"}`}
